...
export const categories: Category[] = [
  {
    ...
    image: '/images/categories/cerveja.jpg',
  ...
  },
  {
    ...
    image: '/images/categories/vinho.jpg',
  ...
  },
  {
    ...
    image: '/images/categories/destilado.jpg',
  ...
  },
  {
    ...
    image: '/images/categories/sem-alcool.jpg',
...
export const products: Product[] = [
  // Cervejas
  {
    ...
    volume: '355ml',
    origin: 'Brasil',
    image: '/images/products/cerveja-ipa.jpg',
    inStock: true,
    featured: true,
    rating: 4.8,
    reviewCount: 124,
  ...
  },
  {
    ...
    volume: '500ml',
    origin: 'Alemanha',
    image: '/images/products/cerveja-weiss.jpg',
    inStock: true,
    featured: true,
    rating: 4.6,
    reviewCount: 67,
  ...
  // Vinhos
  {
    ...
    volume: '750ml',
    origin: 'Chile',
    image: '/images/products/vinho-tinto.jpg',
    inStock: true,
    featured: true,
    rating: 4.7,
    reviewCount: 156,
  ...
  },
  {
    ...
    volume: '750ml',
    origin: 'Argentina',
    image: '/images/products/vinho-branco.jpg',
    inStock: true,
    featured: false,
    rating: 4.4,
    reviewCount: 92,
  ...
  },
  {
    ...
    volume: '750ml',
    origin: 'França',
    image: '/images/products/espumante-rose.jpg',
    inStock: true,
    featured: true,
    rating: 4.9,
    reviewCount: 203,
  ...
  // Destilados
  {
    ...
    volume: '750ml',
    origin: 'Escócia',
    image: '/images/products/whisky-single-malt.jpg',
    inStock: true,
    featured: true,
    rating: 4.8,
    reviewCount: 87,
  ...
  },
  {
    ...
    volume: '700ml',
    origin: 'Inglaterra',
    image: '/images/products/gin-london-dry.jpg',
    inStock: true,
    featured: false,
    rating: 4.5,
    reviewCount: 134,
  ...
  },
  {
    ...
    volume: '700ml',
    origin: 'Brasil',
    image: '/images/products/cachaca-artesanal.jpg',
    inStock: true,
    featured: true,
    rating: 4.6,
    reviewCount: 76,
  ...
  },
  {
    ...
    volume: '250ml',
    origin: 'Brasil',
    image: '/images/products/energetico.jpg',
    inStock: true,
    featured: false,
    rating: 4.1,
    reviewCount: 98,
